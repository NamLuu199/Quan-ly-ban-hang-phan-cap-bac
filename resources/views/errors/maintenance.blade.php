...
<head>
    ...
    <title>Bảo trì và nâng cấp hệ thống</title>   <!--<![endif]--></head>
<style>
    ...
    #tabzilla:before {
        position: relative;
        float: right;
        background-image: url(https://img-fotki.yandex.ru/get/45886/57709865.3/0_fc18a_f01e5a8e_orig);
        height: 36px;
        width: 147px;
    }
    #outer-wrapper {
    ...
    footer[role="contentinfo"] .logo {
        ...
        height:24px;
        margin-right:20px;
        background-image:url("https://img-fotki.yandex.ru/get/67777/57709865.3/0_fc188_7aefa57d_orig");
        text-indent:120%;
        white-space:nowrap;
        overflow:hidden
    }
    @media(-webkit-min-device-pixel-ratio:1.5),(min--moz-device-pixel-ratio:1.5),(-o-min-device-pixel-ratio:3/2),(min-resolution:1.5dppx) {
        footer[role="contentinfo"] .logo {
            background-image:url("https://img-fotki.yandex.ru/get/26827/57709865.3/0_fc189_d346e7fb_orig");
...
<div id="outer-wrapper">
    ...
    <div id="wrapper">
        ...
        <main role="main" class="container">
            <header>
                <h4 style="line-height: 28px;">Xin lỗi quý khách hàng vì sự bất tiện này. <br>Hệ thống đang bảo trì, nâng cấp một số tính năng mới. <br></h4>
                <p>Quý khách hàng hãy quay trở lại sau ngày hôm nay. Cảm ơn đã đồng hành cùng CÔNG TY CỔ PHẦN TẬP ĐOÀN TRUYỀN THÔNG MINH PHÚC.</p>
                <a href="/" class="button-flat-dark" href="#">Trang chủ</a>
            </header>
