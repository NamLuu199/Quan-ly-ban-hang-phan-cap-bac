...
@section('CONTENT_REGION')
    <div class="panel panel-flat">
        <div class="panel-heading d-flex">
            <div class="col-md-3">
                <h3 class="panel-title"><strong>Quản lý lịch sử kích hoạt tài khoản</strong></h3>
            ...
            <table class="table table-striped  table-io">
                ...
                @foreach($listObj as $key=>$val)
                    <tr id="itemRow_{{$val->id}}">
                        ...
                        <td>
                            <b class="text-danger">{{\App\Elibs\Helper::formatMoney($val['phi_giao_dich'])}}</b>
                        </td>
                        <td>
                            <b class="text-danger">{{\App\Elibs\Helper::formatMoney($val['so_tien_muon_giao_dich'])}}</b>
                        </td>
                        <td>
                            <b class="">Tên tài khoản: </b>{{\App\Elibs\Helper::showContent($val['tai_khoan_nhan']['account'])}}<br>
                            <b class="">Tên người nhận: </b>{{\App\Elibs\Helper::showContent($val['tai_khoan_nhan']['name'])}}
                            <br>
                            <div>
                                <a href="javascript:;"
