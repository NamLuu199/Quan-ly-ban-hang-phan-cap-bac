...
<div style="display: none">
    <div class="JS-THUMB-TEMPLATE">
        <div class="col-md-2 col-sm-6 media-item">
            <div class="thumbnail clone-item" data-id="MEDIA">
                <div class="thumb">
...
<script type="text/javascript">
    ...
    var MNG_MEDIA_BUTTON = {
        ...
        setImage: function () {
            console.log(MNG_MEDIA.TARGET_OBJECT)
            if (MNG_MEDIA.SELECTED.length > 0) {
                if (MNG_MEDIA.TARGET_OBJECT) {
                    jQuery(MNG_MEDIA.TARGET_OBJECT.releativeSelector).val(MNG_MEDIA.SELECTED[0]['relativeLink']);
                    jQuery(MNG_MEDIA.TARGET_OBJECT.absoluteSelector).attr('src', MNG_MEDIA.SELECTED[0]['fullSizeLink']);
                }
                jQuery(document).find('[data-dismiss="modal"]').trigger('click');
